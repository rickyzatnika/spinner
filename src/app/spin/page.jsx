...
export default function SpinPage() {
  ...
  return (
    <div className="w-full h-screen p-6 bg-gradient-to-br from-purple-600 to-pink-600 flex flex-col items-center ">
      ...
      {/* Input */}
      <div className="bg-white/20 p-6 rounded-xl backdrop-blur w-full max-w-md mt-8">

        <input
          type="text"
          maxLength={4}
          className="w-full p-3 rounded-lg mb-3 bg-white text-black text-center text-2xl"
